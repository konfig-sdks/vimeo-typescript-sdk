 ...
 * @export
 * @interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Schedule
 */
export interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Schedule {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Schedule
     */
    'daily_time'?: string;
    /**
     ...
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Schedule
     */
    'type'?: LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2ScheduleTypeEnum;
    /**
...
type LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2ScheduleTypeEnum = 'single' | 'weekly'
