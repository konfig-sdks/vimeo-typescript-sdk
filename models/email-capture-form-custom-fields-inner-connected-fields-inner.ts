 ...
 * 
 * @export
 * @interface EmailCaptureFormCustomFieldsInnerConnectedFieldsInner
 */
export interface EmailCaptureFormCustomFieldsInnerConnectedFieldsInner {
    /**
     * The ID of the provider field.
     * @type {string}
     * @memberof EmailCaptureFormCustomFieldsInnerConnectedFieldsInner
     */
     ...
     * @memberof EmailCaptureFormCustomFieldsInnerConnectedFieldsInner
     */
    'provider_id': EmailCaptureFormCustomFieldsInnerConnectedFieldsInnerProviderIdEnum;
}

type EmailCaptureFormCustomFieldsInnerConnectedFieldsInnerProviderIdEnum = '1' | '2' | '3' | '4' | '5' | '6' | '7'
