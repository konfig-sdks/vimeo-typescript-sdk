...
import { WebinarEventEmailQuota } from './webinar-event-email-quota';
import { WebinarEventEmbed } from './webinar-event-embed';
import { WebinarEventMetadata } from './webinar-event-metadata';
import { WebinarEventStreamPrivacy } from './webinar-event-stream-privacy';
...
export interface WebinarEvent {
     ...
     * @memberof WebinarEvent
     */
    'auto_cc_language': WebinarEventAutoCcLanguageEnum;
    /**
     ...
     * @memberof WebinarEvent
     */
    'content_rating': WebinarEventContentRatingEnum;
    /**
    ...
    /**
     * 
     * @type {WebinarEventEmailQuota}
     * @memberof WebinarEvent
     */
    'email_quota': WebinarEventEmailQuota;
    /**
     * 
     * @type {WebinarEventEmbed}
     * @memberof WebinarEvent
     */
     ...
     * @memberof WebinarEvent
     */
    'latency': WebinarEventLatencyEnum;
    /**
     ...
     * @memberof WebinarEvent
     */
    'stream_mode': WebinarEventStreamModeEnum;
    /**
    ...
    /**
     * 
     * @type {WebinarEventStreamPrivacy}
     * @memberof WebinarEvent
     */
...
type WebinarEventAutoCcLanguageEnum = 'de-DE' | 'en-US' | 'es-ES' | 'fr-FR' | 'pt-BR'
type WebinarEventContentRatingEnum = 
type WebinarEventLatencyEnum = 'fail-safe' | 'low' | 'standard'
type WebinarEventPlaylistSortEnum = 'added_first' | 'added_last' | 'alphabetical' | 'arranged' | 'comments' | 'duration' | 'likes' | 'newest' | 'oldest' | 'plays'
type WebinarEventPreferredStreamMethodEnum = 'browser' | 'encoder'
type WebinarEventStatusEnum = 'ended' | 'started'
type WebinarEventStreamModeEnum = 'live' | 'record' | 'simulive'
