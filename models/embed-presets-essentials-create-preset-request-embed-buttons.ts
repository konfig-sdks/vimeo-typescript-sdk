 ...
 * 
 * @export
 * @interface EmbedPresetsEssentialsCreatePresetRequestEmbedButtons
 */
export interface EmbedPresetsEssentialsCreatePresetRequestEmbedButtons {
    /**
     * Whether to show the `embed` button on the embeddable player.
     * @type {boolean}
     * @memberof EmbedPresetsEssentialsCreatePresetRequestEmbedButtons
     */
    'embed'?: boolean;
    /**
