 ...
 * @export
 * @interface LiveEventStreamPrivacy
 */
export interface LiveEventStreamPrivacy {
    /**
     ...
     * @type {string}
     * @memberof LiveEventStreamPrivacy
     */
    'embed': LiveEventStreamPrivacyEmbedEnum;
    /**
     ...
     * @memberof LiveEventStreamPrivacy
     */
    'view': LiveEventStreamPrivacyViewEnum;
}

type LiveEventStreamPrivacyEmbedEnum = 'private' | 'public' | 'whitelist'
type LiveEventStreamPrivacyViewEnum = 'anybody' | 'embed_only' | 'nobody' | 'password' | 'unlisted'
