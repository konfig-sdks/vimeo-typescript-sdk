 ...
 * @export
 * @interface UpdateWebinarRequestPrivacy
 */
export interface UpdateWebinarRequestPrivacy {
    /**
     ...
     * @type {string}
     * @memberof UpdateWebinarRequestPrivacy
     */
    'embed'?: UpdateWebinarRequestPrivacyEmbedEnum;
    /**
     ...
     * @memberof UpdateWebinarRequestPrivacy
     */
    'view'?: UpdateWebinarRequestPrivacyViewEnum;
}

type UpdateWebinarRequestPrivacyEmbedEnum = 'private' | 'public' | 'whitelist'
type UpdateWebinarRequestPrivacyViewEnum = 'anybody' | 'nobody' | 'password' | 'team'
