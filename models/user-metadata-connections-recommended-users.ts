 ...
 * @export
 * @interface UserMetadataConnectionsRecommendedUsers
 */
export interface UserMetadataConnectionsRecommendedUsers {
    /**
     * An array of HTTP methods permitted on this URI. This data requires a bearer token with the `private` scope.
     * @type {Array<string>}
     * @memberof UserMetadataConnectionsRecommendedUsers
     */
