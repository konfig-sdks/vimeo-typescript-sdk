 ...
 * @export
 * @interface CreateWebinarRequestPrivacy
 */
export interface CreateWebinarRequestPrivacy {
    /**
     ...
     * @type {string}
     * @memberof CreateWebinarRequestPrivacy
     */
    'embed'?: CreateWebinarRequestPrivacyEmbedEnum;
    /**
     ...
     * @memberof CreateWebinarRequestPrivacy
     */
    'view'?: CreateWebinarRequestPrivacyViewEnum;
}

type CreateWebinarRequestPrivacyEmbedEnum = 'private' | 'public' | 'whitelist'
type CreateWebinarRequestPrivacyViewEnum = 'anybody' | 'nobody' | 'password' | 'team'
