 ...
 * @export
 * @interface LiveEssentialsCreateEventForUserRequestSchedule
 */
export interface LiveEssentialsCreateEventForUserRequestSchedule {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsCreateEventForUserRequestSchedule
     */
    'daily_time'?: string;
    /**
     ...
     * @memberof LiveEssentialsCreateEventForUserRequestSchedule
     */
    'type'?: LiveEssentialsCreateEventForUserRequestScheduleTypeEnum;
    /**
...
type LiveEssentialsCreateEventForUserRequestScheduleTypeEnum = 'single' | 'weekly'
