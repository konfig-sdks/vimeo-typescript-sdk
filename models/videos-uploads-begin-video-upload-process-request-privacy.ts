 ...
 * 
 * @export
 * @interface VideosUploadsBeginVideoUploadProcessRequestPrivacy
 */
export interface VideosUploadsBeginVideoUploadProcessRequestPrivacy {
    /**
     * Whether a user can add the video to a showcase, channel, or group.
     * @type {boolean}
     * @memberof VideosUploadsBeginVideoUploadProcessRequestPrivacy
     */
    'add'?: boolean;
    /**
     ...
     * @memberof VideosUploadsBeginVideoUploadProcessRequestPrivacy
     */
    'comments'?: VideosUploadsBeginVideoUploadProcessRequestPrivacyCommentsEnum;
    /**
     ...
     * @memberof VideosUploadsBeginVideoUploadProcessRequestPrivacy
     */
    'embed'?: VideosUploadsBeginVideoUploadProcessRequestPrivacyEmbedEnum;
    /**
     ...
     * @memberof VideosUploadsBeginVideoUploadProcessRequestPrivacy
     */
    'view'?: VideosUploadsBeginVideoUploadProcessRequestPrivacyViewEnum;
}

type VideosUploadsBeginVideoUploadProcessRequestPrivacyCommentsEnum = 'anybody' | 'contacts' | 'nobody'
type VideosUploadsBeginVideoUploadProcessRequestPrivacyEmbedEnum = 'private' | 'public' | 'whitelist'
type VideosUploadsBeginVideoUploadProcessRequestPrivacyViewEnum = 'anybody' | 'contacts' | 'disable' | 'nobody' | 'password' | 'unlisted' | 'users'
