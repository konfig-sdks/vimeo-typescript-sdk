 ...
 * 
 * @export
 * @interface UsersEssentialsEditVimeoAccountRequestVideosPrivacy
 */
export interface UsersEssentialsEditVimeoAccountRequestVideosPrivacy {
    /**
     * Whether the user can add videos to showcases, channels, or groups by default.
     * @type {boolean}
     * @memberof UsersEssentialsEditVimeoAccountRequestVideosPrivacy
     */
    'add'?: boolean;
    /**
     ...
     * @memberof UsersEssentialsEditVimeoAccountRequestVideosPrivacy
     */
    'comments'?: UsersEssentialsEditVimeoAccountRequestVideosPrivacyCommentsEnum;
    /**
     ...
     * @memberof UsersEssentialsEditVimeoAccountRequestVideosPrivacy
     */
    'embed'?: UsersEssentialsEditVimeoAccountRequestVideosPrivacyEmbedEnum;
    /**
     ...
     * @memberof UsersEssentialsEditVimeoAccountRequestVideosPrivacy
     */
    'view'?: UsersEssentialsEditVimeoAccountRequestVideosPrivacyViewEnum;
}

type UsersEssentialsEditVimeoAccountRequestVideosPrivacyCommentsEnum = 'anybody' | 'contacts' | 'nobody'
type UsersEssentialsEditVimeoAccountRequestVideosPrivacyEmbedEnum = 'private' | 'public' | 'whitelist'
type UsersEssentialsEditVimeoAccountRequestVideosPrivacyViewEnum = 'anybody' | 'contacts' | 'disable' | 'nobody' | 'password' | 'unlisted' | 'users'
