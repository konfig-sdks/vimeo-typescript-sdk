 ...
 * @export
 * @interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy
 */
export interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy
     */
    'view'?: LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacyViewEnum;
}

type LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacyViewEnum = 'anybody' | 'embed_only' | 'nobody' | 'password' | 'unlisted'
