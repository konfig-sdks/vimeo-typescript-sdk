 ...
 * @export
 * @interface PresetSettingsPlayButton
 */
export interface PresetSettingsPlayButton {
    /**
     ...
     * @type {string}
     * @memberof PresetSettingsPlayButton
     */
    'position': PresetSettingsPlayButtonPositionEnum;
}

type PresetSettingsPlayButtonPositionEnum = 'auto' | 'bottom' | 'center'
