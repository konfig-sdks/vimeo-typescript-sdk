 ...
 * 
 * @export
 * @interface VideosUploadsBeginVideoUploadProcessRequestSpatialDirectorTimelineInner
 */
export interface VideosUploadsBeginVideoUploadProcessRequestSpatialDirectorTimelineInner {
    /**
     ...
     * @type {number}
     * @memberof VideosUploadsBeginVideoUploadProcessRequestSpatialDirectorTimelineInner
     */
    'pitch': number;
    /**
