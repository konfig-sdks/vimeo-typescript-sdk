 ...
 * @export
 * @interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy
 */
export interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy
     */
    'view'?: LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacyViewEnum;
}

type LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacyViewEnum = 'anybody' | 'embed_only' | 'nobody' | 'password' | 'unlisted'
