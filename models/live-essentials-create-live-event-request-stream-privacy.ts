 ...
 * @export
 * @interface LiveEssentialsCreateLiveEventRequestStreamPrivacy
 */
export interface LiveEssentialsCreateLiveEventRequestStreamPrivacy {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsCreateLiveEventRequestStreamPrivacy
     */
    'view'?: LiveEssentialsCreateLiveEventRequestStreamPrivacyViewEnum;
}

type LiveEssentialsCreateLiveEventRequestStreamPrivacyViewEnum = 'anybody' | 'embed_only' | 'nobody' | 'password' | 'unlisted'
