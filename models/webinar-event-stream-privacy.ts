 ...
 * @export
 * @interface WebinarEventStreamPrivacy
 */
export interface WebinarEventStreamPrivacy {
    /**
     ...
     * @type {string}
     * @memberof WebinarEventStreamPrivacy
     */
    'embed': WebinarEventStreamPrivacyEmbedEnum;
    /**
     ...
     * @memberof WebinarEventStreamPrivacy
     */
    'view': WebinarEventStreamPrivacyViewEnum;
}

type WebinarEventStreamPrivacyEmbedEnum = 'private' | 'public' | 'whitelist'
type WebinarEventStreamPrivacyViewEnum = 'anybody' | 'embed_only' | 'nobody' | 'password' | 'unlisted'
