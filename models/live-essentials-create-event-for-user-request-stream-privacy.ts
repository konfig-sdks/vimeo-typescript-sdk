 ...
 * @export
 * @interface LiveEssentialsCreateEventForUserRequestStreamPrivacy
 */
export interface LiveEssentialsCreateEventForUserRequestStreamPrivacy {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsCreateEventForUserRequestStreamPrivacy
     */
    'view'?: LiveEssentialsCreateEventForUserRequestStreamPrivacyViewEnum;
}

type LiveEssentialsCreateEventForUserRequestStreamPrivacyViewEnum = 'anybody' | 'embed_only' | 'nobody' | 'password' | 'unlisted'
