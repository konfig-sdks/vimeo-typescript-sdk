 ...
 * 
 * @export
 * @interface VideosTextTracksAddTextTrackToVideoRequest
 */
export interface VideosTextTracksAddTextTrackToVideoRequest {
    /**
     ...
     * @type {boolean}
     * @memberof VideosTextTracksAddTextTrackToVideoRequest
     */
    'active'?: boolean;
    /**
     ...
     * @memberof VideosTextTracksAddTextTrackToVideoRequest
     */
    'type': VideosTextTracksAddTextTrackToVideoRequestTypeEnum;
}

type VideosTextTracksAddTextTrackToVideoRequestTypeEnum = 'captions' | 'chapters' | 'descriptions' | 'metadata' | 'subtitles'
