 ...
 * @export
 * @interface LiveEssentialsCreateLiveEventRequestInteractionToolsSettings
 */
export interface LiveEssentialsCreateLiveEventRequestInteractionToolsSettings {
    /**
     * Whether anonymous questions are disabled for the interaction tools settings.
     * @type {boolean}
     * @memberof LiveEssentialsCreateLiveEventRequestInteractionToolsSettings
     */
