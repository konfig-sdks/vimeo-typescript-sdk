 ...
 * @export
 * @interface WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestSchedule
 */
export interface WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestSchedule {
    /**
     ...
     * @type {string}
     * @memberof WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestSchedule
     */
    'daily_time'?: string;
    /**
     ...
     * @memberof WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestSchedule
     */
    'type'?: WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestScheduleTypeEnum;
    /**
...
type WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestScheduleTypeEnum = 'single' | 'weekly'
