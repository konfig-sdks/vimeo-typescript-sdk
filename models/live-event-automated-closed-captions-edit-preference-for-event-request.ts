 ...
 * 
 * @export
 * @interface LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest
 */
export interface LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest {
    /**
     * Whether automated closed captions are enabled for the event.
     * @type {boolean}
     * @memberof LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest
     */
     ...
     * @memberof LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest
     */
    'auto_cc_lang'?: LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequestAutoCcLangEnum;
}

type LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequestAutoCcLangEnum = 'de-DE' | 'en-US' | 'es-ES' | 'fr-FR' | 'pt-BR'
