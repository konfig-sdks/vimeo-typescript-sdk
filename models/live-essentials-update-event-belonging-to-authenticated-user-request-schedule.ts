 ...
 * @export
 * @interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestSchedule
 */
export interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestSchedule {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestSchedule
     */
    'daily_time'?: string;
    /**
     ...
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestSchedule
     */
    'type'?: LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestScheduleTypeEnum;
    /**
...
type LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestScheduleTypeEnum = 'single' | 'weekly'
