 ...
 * @export
 * @interface LiveEventMetadataConnectionsPreLiveVideo
 */
export interface LiveEventMetadataConnectionsPreLiveVideo {
    /**
     * An array of the HTTP methods permitted on this URI.
     * @type {Array<string>}
     * @memberof LiveEventMetadataConnectionsPreLiveVideo
     */
     ...
     * @memberof LiveEventMetadataConnectionsPreLiveVideo
     */
    'status': LiveEventMetadataConnectionsPreLiveVideoStatusEnum;
    /**
...
type LiveEventMetadataConnectionsPreLiveVideoStatusEnum = 'pending' | 'ready' | 'streaming' | 'unavailable'
