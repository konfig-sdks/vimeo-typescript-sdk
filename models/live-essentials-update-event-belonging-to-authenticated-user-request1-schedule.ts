 ...
 * @export
 * @interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule
 */
export interface LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule {
    /**
     ...
     * @type {string}
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule
     */
    'daily_time'?: string;
    /**
     ...
     * @memberof LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule
     */
    'type'?: LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ScheduleTypeEnum;
    /**
...
type LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ScheduleTypeEnum = 'single' | 'weekly'
