 ...
 * 
 * @export
 * @interface LiveEventDestinationsCreateDestinationRequest
 */
export interface LiveEventDestinationsCreateDestinationRequest {
    /**
     * The title to display for the simulcast.
     * @type {string}
     * @memberof LiveEventDestinationsCreateDestinationRequest
     */
    'display_name': string;
    /**
     ...
     * @memberof LiveEventDestinationsCreateDestinationRequest
     */
    'privacy'?: LiveEventDestinationsCreateDestinationRequestPrivacyEnum;
    /**
     ...
     * @memberof LiveEventDestinationsCreateDestinationRequest
     */
    'service_name': LiveEventDestinationsCreateDestinationRequestServiceNameEnum;
    /**
     * The RTMP stream key.
     * @type {string}
     * @memberof LiveEventDestinationsCreateDestinationRequest
     ...
     * @memberof LiveEventDestinationsCreateDestinationRequest
     */
    'type': LiveEventDestinationsCreateDestinationRequestTypeEnum;
}

type LiveEventDestinationsCreateDestinationRequestPrivacyEnum = 'CONNECTIONS' | 'PUBLIC' | 'all_friends' | 'everyone' | 'private' | 'public' | 'self' | 'unlisted'
type LiveEventDestinationsCreateDestinationRequestServiceNameEnum = 'custom_rtmp' | 'facebook' | 'linkedin' | 'youtube'
type LiveEventDestinationsCreateDestinationRequestTypeEnum = 'channel' | 'custom' | 'organization' | 'page' | 'profile'
