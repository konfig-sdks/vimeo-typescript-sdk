 ...
 * 
 * @export
 * @interface UploadVideoRequestPrivacy
 */
export interface UploadVideoRequestPrivacy {
    /**
     * Whether a user can add the video to a showcase, channel, or group.
     * @type {boolean}
     * @memberof UploadVideoRequestPrivacy
     */
    'add'?: boolean;
    /**
     ...
     * @memberof UploadVideoRequestPrivacy
     */
    'comments'?: UploadVideoRequestPrivacyCommentsEnum;
    /**
     ...
     * @memberof UploadVideoRequestPrivacy
     */
    'embed'?: UploadVideoRequestPrivacyEmbedEnum;
    /**
     ...
     * @memberof UploadVideoRequestPrivacy
     */
    'view'?: UploadVideoRequestPrivacyViewEnum;
}

type UploadVideoRequestPrivacyCommentsEnum = 'anybody' | 'contacts' | 'nobody'
type UploadVideoRequestPrivacyEmbedEnum = 'private' | 'public' | 'whitelist'
type UploadVideoRequestPrivacyViewEnum = 'anybody' | 'contacts' | 'disable' | 'nobody' | 'password' | 'unlisted' | 'users'
