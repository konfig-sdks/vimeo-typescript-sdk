 ...
 * 
 * @export
 * @interface LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
 */
export interface LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1 {
    /**
     * The title to display for the simulcast.
     * @type {string}
     * @memberof LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
     */
    'display_name': string;
    /**
     ...
     * @memberof LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
     */
    'privacy'?: LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1PrivacyEnum;
    /**
     ...
     * @memberof LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
     */
    'service_name': LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1ServiceNameEnum;
    /**
     * The RTMP stream key.
     * @type {string}
     * @memberof LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
     ...
     * @memberof LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1
     */
    'type': LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1TypeEnum;
}

type LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1PrivacyEnum = 'CONNECTIONS' | 'PUBLIC' | 'all_friends' | 'everyone' | 'private' | 'public' | 'self' | 'unlisted'
type LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1ServiceNameEnum = 'custom_rtmp' | 'facebook' | 'linkedin' | 'youtube'
type LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1TypeEnum = 'channel' | 'custom' | 'organization' | 'page' | 'profile'
