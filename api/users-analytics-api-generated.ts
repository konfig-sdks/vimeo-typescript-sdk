...
export const UsersAnalyticsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'country' | 'embed_domain' | 'total' | 'video'} dimension The data dimension by which to group the results.  Option descriptions:  * &#x60;country&#x60; - Group the results by country.  * &#x60;embed_domain&#x60; - Group the results by embed domain.  * &#x60;total&#x60; - Group the results by the time range provided.  * &#x60;video&#x60; - Group the results by video. 
         ...
         */
        getMetrics: async (userId: number, dimension: 'country' | 'embed_domain' | 'total' | 'video', from: string, to: string, direction?: 'asc' | 'desc', filterContent?: string, filterCountries?: Array<string>, filterDeviceTypes?: Array<string>, filterEmbedDomains?: Array<string>, filterStreamingTypes?: Array<string>, page?: number, perPage?: number, sort?: 'average_percent_watched' | 'average_time_watched' | 'comments' | 'country' | 'default' | 'downloads' | 'embed_domain' | 'finishes' | 'impressions' | 'like' | 'time' | 'total_time_watched' | 'unique_impressions' | 'unique_viewers' | 'video' | 'views', timeInterval?: 'day' | 'month' | 'none' | 'week' | 'year', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getUserMetrics: async (dimension: 'country' | 'embed_domain' | 'total' | 'video', from: string, to: string, direction?: 'asc' | 'desc', filterContent?: string, filterCountries?: Array<string>, filterDeviceTypes?: Array<string>, filterEmbedDomains?: Array<string>, filterStreamingTypes?: Array<string>, page?: number, perPage?: number, sort?: 'average_percent_watched' | 'average_time_watched' | 'comments' | 'country' | 'default' | 'downloads' | 'embed_domain' | 'finishes' | 'impressions' | 'like' | 'time' | 'total_time_watched' | 'unique_impressions' | 'unique_viewers' | 'video' | 'views', timeInterval?: 'day' | 'month' | 'none' | 'week' | 'year', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'dimension' is not null or undefined
...
export type UsersAnalyticsApiGetMetricsRequest = {
    ...
    * @type {'country' | 'embed_domain' | 'total' | 'video'}
    * @memberof UsersAnalyticsApiGetMetrics
    */
    readonly dimension: 'country' | 'embed_domain' | 'total' | 'video'
    ...
    * @type {'average_percent_watched' | 'average_time_watched' | 'comments' | 'country' | 'default' | 'downloads' | 'embed_domain' | 'finishes' | 'impressions' | 'like' | 'time' | 'total_time_watched' | 'unique_impressions' | 'unique_viewers' | 'video' | 'views'}
    * @memberof UsersAnalyticsApiGetMetrics
    */
    readonly sort?: 'average_percent_watched' | 'average_time_watched' | 'comments' | 'country' | 'default' | 'downloads' | 'embed_domain' | 'finishes' | 'impressions' | 'like' | 'time' | 'total_time_watched' | 'unique_impressions' | 'unique_viewers' | 'video' | 'views'
